...
/***/ "./public/plugins/notiflix/build/notiflix-confirm-aio.js":
/*!***************************************************************!*\
  !*** ./public/plugins/notiflix/build/notiflix-confirm-aio.js ***!
  \***************************************************************/
...
/***/ "./public/plugins/notiflix/build/notiflix-loading-aio.js":
/*!***************************************************************!*\
  !*** ./public/plugins/notiflix/build/notiflix-loading-aio.js ***!
  \***************************************************************/
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./public/plugins/notiflix/build/notiflix-notify-aio.js":
/*!**************************************************************!*\
  !*** ./public/plugins/notiflix/build/notiflix-notify-aio.js ***!
  \**************************************************************/
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var _public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/plugins/notiflix/build/notiflix-loading-aio */ "./public/plugins/notiflix/build/notiflix-loading-aio.js");
/* harmony import */ var _public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../public/plugins/notiflix/build/notiflix-notify-aio */ "./public/plugins/notiflix/build/notiflix-notify-aio.js");
/* harmony import */ var _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _public_plugins_notiflix_build_notiflix_confirm_aio__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../public/plugins/notiflix/build/notiflix-confirm-aio */ "./public/plugins/notiflix/build/notiflix-confirm-aio.js");
/* harmony import */ var _public_plugins_notiflix_build_notiflix_confirm_aio__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_public_plugins_notiflix_build_notiflix_confirm_aio__WEBPACK_IMPORTED_MODULE_2__);
...
var dt_route = base_url + '/attendant/ajax';
var dt_attendant_list = setDataTable('table-attendant-list', columns, dt_route); // init filepond

FilePond.registerPlugin(FilePondPluginImagePreview, FilePondPluginImageExifOrientation, FilePondPluginFileValidateSize, FilePondPluginFileValidateType); // Select the file input and use
...
var pond = document.querySelector('.filepond'); // listen for events
...
var myModalEl = document.getElementById('modalCreateAttendant');
...
function importFile() {
  ...
  $.ajax({
    ...
    beforeSend: function beforeSend() {
      _public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0__.Loading.hourglass(i18n.view.processing);
    },
    success: function success(res) {
      _public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0__.Loading.remove();
      _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.success(i18n.view.success_import_data);
    ...
    error: function error(err) {
      ...
      if (err.responseJSON) {
        _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.warning(err.responseJSON.message);
      } else {
        _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.warning(i18n.view.failed_communication);
      }
    }
  });
}
...
function saveAttendant() {
  ...
  var url = base_url + '/attendant';
  var validate = validateForm('form-update', 'error');
  ...
  if (validate) {
    $.ajax({
      ...
      success: function success(res) {
        console.log('res', res);
        _public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0__.Loading.remove();
        _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.success(res.message);
      ...
      error: function error(err) {
        console.log('err', err);
        _public_plugins_notiflix_build_notiflix_loading_aio__WEBPACK_IMPORTED_MODULE_0__.Loading.remove();
        _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.warning(err.responseJSON ? err.responseJSON.message : i18n.view.failed_communication);
      }
    });
  }
}
...
function deleteItem(id) {
  _public_plugins_notiflix_build_notiflix_confirm_aio__WEBPACK_IMPORTED_MODULE_2__.Confirm.show(i18n.view.delete_confirm, i18n.view.delete_confirmation, i18n.view.yes_delete, i18n.view.no, function () {
    $.ajax({
      type: 'DELETE',
...
/******/ 	__webpack_require__.O(undefined, ["css/employee"], () => (__webpack_require__("./resources/js/attendant.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/employee"], () => (__webpack_require__("./resources/css/employee.less")))
