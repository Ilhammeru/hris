...
var datetime = "Last Sync: " + currentdate.getDate() + "-" + addZero(currentdate.getMonth() + 1) + "-" + currentdate.getFullYear() + " " + currentdate.getHours() + ":" + currentdate.getMinutes();
...
var dt_attendant_list; // datatables
...
var columns = [{
  ...
  data: 'option_finisher',
  name: 'option_finisher'
}, {
  data: 'start_date',
  name: 'start_date'
}, {
...
var dt_route = base_url + '/event/ajax';
var dt_event_list = setDataTable('table-event-list', columns, dt_route); // event modal
...
function saveEvent() {
  var form = $('#form-update-event');
  var url = base_url + '/event';
  var data = form.serialize();
  var validate = validateForm('form-update-event', 'error');
...
function initListAttendees(id) {
  ...
  var dt_route = base_url + '/event/ajax/' + id;
