...
var signaturePad;
var myModalEl = document.getElementById('modalSignature');
...
function searchData(option) {
  if ($('#attendant_id').val() != '') {
    if (option == 1) {
      ...
      _public_plugins_notiflix_build_notiflix_confirm_aio__WEBPACK_IMPORTED_MODULE_2__.Confirm.show(i18n.view.save_confirm, i18n.view.save_confirmation, i18n.view.yes_save, i18n.view.no, function () {
        var form = $('#form-check-in');
        ...
        $.ajax({
          ...
          success: function success(res) {
            ...
            if (res.status) {
              _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.warning(res.message);
            } else {
...
function submitData() {
  if (signaturePad.isEmpty()) {
    _public_plugins_notiflix_build_notiflix_notify_aio__WEBPACK_IMPORTED_MODULE_1__.Notify.warning(i18n.view.signature_failed);
  } else {
